        ...
        <div class="content-wrapper pt-3">
            ...
            <div class="content">
                <div class="container-fluid">
                        ...
                        <div class="col-md-8 offset-md-2">
                            <form action="#" onsubmit="return false;">
                                <div class="input-group">
                                    <input type="search" class="form-control form-control-lg" placeholder="Buscar..." autofocus>
                    ...
                    <div class="row mt-3">
                        <div class="col-12">
                            <h3 class="display-5">Resultados</h3>
                            <div class="card">
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <table id="logs" class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            <?php while ($DatosCliente = $Res_Clientes->fetch_assoc()) { ?>
                                                <tr>
                                                    <td><a href="/cliente?id=<?= $DatosCliente['IdCliente'] ?>"><?= $DatosCliente['IdCliente'] ?></a></td>
                                                    ...
                                                    <td>
                                                        <div class="d-flex justify-content-around">
                                                            <a class="btn btn-sm mx-1 bg-info" title="Agregar" onclick="javascript:nuevaCotizacion(<?= $DatosCliente['IdCliente'] ?>);">
                                                                <i class="fa fa-plus"></i>
                                                            </a>
