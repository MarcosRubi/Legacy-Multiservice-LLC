                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Cotizaciones realizadas a <strong>Marcos Daniel Rubí</strong>
                                    </h3>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <table id="list-results" class="table table-bordered table-hover table-striped">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>1</td>
                                                <td>Telemarketing</td>
                                                <td style="width:4.1rem;">02-07-2022</td>
                                                <td>Son fechas tentativas</td>
                                                <td>0.00</td>
                                                <td>0.00</td>
                                            </tr>
                                            <tr>
